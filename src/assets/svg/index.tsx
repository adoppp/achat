...
export const IconCheckbox = (
  <svg viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
    <path
      fill="none"
      d="M5.5,11.3L9,14.8L20.2,3.3l0,0c-0.5-1-1.5-1.8-2.7-1.8h-13
        c-1.7,0-3,1.3-3,3v13c0,1.7,1.3,3,3,3h13c1.7,0,3-1.3,3-3v-13
...
export const IconSearch = (
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    <circle cx="6.6001" cy="6.6001" r="6" stroke-width="1.2"/>
    <path d="M11 11L15.2426 15.2426" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
);

export const IconNewChat = (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
    <path d="M16 2H8C4 2 2 4 2 8V21C2 21.55 2.45 22 3 22H16C20 22 22 20 22 16V8C22 4 20 2 16 2Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M8.5 12H15.5"  stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M12 15.5V8.5"stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
);
...
export const IconInfo = (
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    <path d="M8 4.5V9" stroke-width="1.2" stroke-linecap="round"/>
